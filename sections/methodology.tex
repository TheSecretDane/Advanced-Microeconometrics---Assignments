...
%Suppose we have a set of independent standard normal variables, $\{lcap,lemp\}$ denoted $Y_1,Y_2$ respectively. The sum of the squared variables follows a $\chi^2_1$ distribution: \begin{align*} \xi=\sum^2_{i=1}Y^2_i \longrightarrow\xi\sim \chi^2 \end{align*}
